...
export class WizardComponent implements OnInit, AfterViewInit{
  ...
  focus2;
    ...
    if(this.router.url =='/user-profile/info/changepassword'){
    this.selectedTab ='changepassword'
    }else if(this.router.url =='/user-profile/info/account'){
      ...
      if ($(".selectpicker").length != 0) {
        ...
        $('.card-wizard').bootstrapWizard({
            ...
            onInit: function(tab: any, navigation: any, index: any){
              ...
              index = navigation.find('li.activeTab').attr('index')
              let $first_li = navigation.find('li.activeTab a').html();
